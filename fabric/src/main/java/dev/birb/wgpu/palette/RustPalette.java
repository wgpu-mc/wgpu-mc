...
//    public static final Cleaner CLEANER = Cleaner.create();
    ...
    public RustPalette(long rustPalettePointer, long rustIdList, IndexedIterable<T> idList, PaletteResizeListener<T> listener, int bits) {
        this.slabIndex = rustPalettePointer;
...
//        CLEANER.register(this, () -> WgpuNative.destroyPalette(rustPalettePointer));
    ...
    public int index(T object) {
        ...
        int index = WgpuNative.paletteIndex(this.slabIndex, object, accessor.getRustBlockStateIndex());
    ...
    @Override
    public T get(int id) {
        T t = (T) WgpuNative.paletteGet(this.slabIndex, id);
        return t;
    }
    ...
    public void readPacket(PacketByteBuf buf) {
        ...
        int wmRead = WgpuNative.paletteReadPacket(this.slabIndex, buf.array(), index, blockstateOffsets);
    ...
    public Palette<T> copy() {
        return new RustPalette<T>(WgpuNative.copyPalette(this.slabIndex), this.rustIdList, this.idList, this.listener, this.bits);
    }
