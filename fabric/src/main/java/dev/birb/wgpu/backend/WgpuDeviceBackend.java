...
public class WgpuDeviceBackend implements GpuDeviceBackend {
...
//    private final BiFunction<Identifier, ShaderType, String> shaderSourceGetter;
    ...
    public WgpuDeviceBackend(long window, ShaderSource shaderSource) {
        WgpuNative.createDevice(GLFWNativeWin32.glfwGetWin32Window(window), 0);
