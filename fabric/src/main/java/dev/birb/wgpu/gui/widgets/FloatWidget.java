...
public class FloatWidget extends Widget implements IOptionWidget {
	private final FloatOption option;

	private boolean dragging;

	public FloatWidget(int x, int y, int width, FloatOption option) {
	...
	private int getHandleX() {
		double delta = (option.get() - option.min) / (option.max - option.min);
