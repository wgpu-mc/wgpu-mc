...
use wgpu_mc::mc::entity::{Cuboid, CuboidUV, DescribedEntityInstances, EntityInstance, EntityManager, EntityModel, EntityPart, PartTransform, UploadedEntityInstanceBuffer};
...
pub fn describe_entity(wm: &WmRenderer) -> (UploadedEntityInstanceBuffer, Arc<EntityModel>) {
    ...
    ((entity_instance_buffer, entity_instance_bind_group), player_model)
}